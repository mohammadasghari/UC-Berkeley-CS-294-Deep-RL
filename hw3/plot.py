...
to compare them -- see their learning curves side-by-side. Just call
    ...
    python plot.py data/ac_ntu_1_ngsptu_1_CartPole-v0_12-02-2019_21-28-40 data/ac_ntu_1_ngsptu_100_CartPole-v0_12-02-2019_21-31-11 data/ac_ntu_10_ngsptu_10_CartPole-v0_12-02-2019_21-32-47 data/ac_ntu_100_ngsptu_1_CartPole-v0_12-02-2019_21-29-23
    
    python plot.py data/policy_gradient_InvertedPendulum-v2_12-02-2019_23-53-11 data/policy_gradient_baseline_InvertedPendulum-v2_13-02-2019_09-50-43 data/ac_actor_critic_InvertedPendulum-v2_12-02-2019_23-14-48
    
    python plot.py data/policy_gradient_HalfCheetah-v2_13-02-2019_00-29-28 data/policy_gradient_baseline_HalfCheetah-v2_13-02-2019_01-26-34 data/ac_actor_critic_HalfCheetah-v2_12-02-2019_23-22-05
...
def plot_data(data, value="AverageReturn"):
    ...
    # plt.ylim([-10,250])
    plt.ylim([0, 1200])
    plt.savefig('./figures/cmp_InvertedPendulum.png')
    plt.savefig('./figures/cmp_InvertedPendulum.pdf')
    plt.show()
