...
class Agent(object):
    ...
    def estimate_advantage(self, ob_no, next_ob_no, re_n, terminal_n):
        ...
        q_s_a = re_n + self.gamma * (1 - terminal_n) * v_s_next
    ...
    def update_critic(self, ob_no, next_ob_no, re_n, terminal_n):
        ...
        for _ in range(self.num_target_updates):
            ...
            v_s_next = self.sess.run(self.critic_prediction, feed_dict={self.sy_ob_no: next_ob_no})
            target_values = re_n + self.gamma * (1 - terminal_n) * v_s_next

            for __ in range(self.num_grad_steps_per_target_update):

                self.sess.run(self.critic_update_op, feed_dict={self.sy_ob_no: ob_no, self.sy_target_n: target_values})
